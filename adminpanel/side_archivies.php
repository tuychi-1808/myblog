                        ...
                        <table class="table table-dark mb-0">
                            ...
                            <tr>
                                ...
                                <th class="align-content-center">
                                    <a href="insert_sidearchive.php"><button type="button" class="btn btn-outline-success">Добавить</button></a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            foreach ($result as $row):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['side_date']?></td>
                                    <td>
                                        <a href="edit_sidearchives.php?id=<?php echo $row['id']?>"><button type="button" class="btn btn-outline-primary">Редактировать</button></a>
                                        <a href="delete.php?id=<?php echo $row['id']?>&dbname=sidearchive&url=side_archivies.php&row=id"><<button type="button" class="btn btn-outline-danger">Удалить</button></a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
