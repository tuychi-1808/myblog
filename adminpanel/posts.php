                        ...
                        <table class="table table-dark mb-6">
                            ...
                            <tr>
                                ...
                                <th class="align-content-center">
                                    <a href="insert_posts.php" class=""><<button type="button" class="btn btn-outline-success">Добавить</button></a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            foreach ($result as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="delete.php?id=<?php echo $row['id']?>&dbname=posts&secdbname=categories&url=posts.php&row=id"><button type="button" class="btn btn-outline-danger">Удалить</button></a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
