...
<?php
if (isset($_POST['sidearchive_save'])){
    $title = $_POST['title'];
    $date = $_POST['date'];

    if ($DB ->query("INSERT INTO sidearchive(id, title, side_date) VALUES (?,?,?)", array(null, $title, $date)))
    {
        ...
        <form class="mt-5" method="post">
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    <label for="validationDefault01">Название архива</label>
                    <input type="text" name="title" class="form-control" id="validationDefault01" >
                </div>
                <div class="col-md-6 mb-3">
                    <label for="validationDefault01">Дата архива</label>
            ...
            <button class="btn btn-primary"  type="submit" name="sidearchive_save">Сохранить</button>
        </form>
