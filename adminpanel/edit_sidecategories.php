...
if (isset($_POST['sidebarcat_save'])){
    $title = $_POST['title'];
    $theme = $_POST['theme'];
    $sidebarcatrow_id = $_POST['sidebarcatrowrow_id'];

    $DB ->query("UPDATE  sidecategories SET  title = ?, theme =? WHERE id = ?", array("$title", "$theme", "$sidebarcatrow_id"));
...
<div class="page-wrapper">
    ...
    <div class="topbar">
        ...
        <nav class="navbar-custom text-center">
            <h2 class="p-3">Внести изменение sidecategories</h2>
        </nav>
        <!-- end navbar-->
    </div>
    ...
    <div class="container">
        <?php
        $result = $DB ->query("SELECT * FROM sidecategories WHERE id = ?", array("$id"));
            ...
            <form class="mt-5" method="post">
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="theme" value="<?php echo $row["theme"];?>" class="form-control" id="validationDefault01" >
                    </div>
                </div>
                <input type="hidden" name="sidebarcatrowrow_id" value="<?php echo $row["id"];?>">
